...
# Video Key Insights Behave Test Runner
# This script demonstrates how to run the behave tests for video key insights

set -e

echo "🧪 Video Key Insights Behave Test Runner"
echo "========================================"
...
if [ "$SERVER_RUNNING" = true ]; then
    ...
    echo "   2. Run: uv run behave features/"
fi
