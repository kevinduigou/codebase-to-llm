...
from codebase_to_llm.interface.context_buffer import ContextBufferWidget
...
class ContextBufferWidget(QListWidget):
    """ContextBufferWidget: accepting drops from the tree view."""
...
class MainWindow(QMainWindow):
    ...
    def __init__(
        ...
        self._context_buffer_widget = ContextBufferWidget(initial_root, self._copy_context)
